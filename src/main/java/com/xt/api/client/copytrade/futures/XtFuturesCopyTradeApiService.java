...
public interface XtFuturesCopyTradeApiService {
    ...
    @GET("/future/copytrade/user/v1/public/copy-trade/symbol-list")
    ...
    @GET("/future/copytrade/user/v1/public/copy-trade/leader-detail-v2")
